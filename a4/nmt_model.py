...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.decoder = nn.LSTMCell(2*embed_size, hidden_size, bias=True)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        last_hidden1 = torch.cat((last_hidden[0], last_hidden[1]), 1)
        last_cell1 = torch.cat((last_cell[0], last_cell[1]), 1)
        init_decoder_hidden = self.h_projection(last_hidden1)
        init_decoder_cell   = self.c_projection(last_cell1)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        dec = torch.unsqueeze(dec_hidden, 2)
        e_t = torch.bmm(enc_hiddens_proj, dec)
